...
const getThemeVariables = (theme: ThemeType) => css`
  ...
  --primary2-color: ${themeObject[theme].primary2};
  ...
  --border-bray-color: ${themeObject[theme].alto};
`;
...
export const antOverrideCssVariables = css`
  --ant-primary-1: var(--primary2-color) !important;
`;
